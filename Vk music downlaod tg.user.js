...
(function(window, undefined) {
                  ...
                  .then(({ done, value }) => {
                    ...
                    try {
                      div.style =
                        ...
                        (loaded / total) * 100 +
                        "%;height:" +
                        getAudioPlayer()._currentPlayingRows[0].children[0]
                          .offsetHeight +
                        "px;";
                    } catch (error) {}
                    read();
              ...
              function read() {
                reader
                  ...
                  .then(({ done, value }) => {
                    ...
                    try {
                      div.style =
                        "background-color: #2196f340;    border-radius: 4px;position: absolute;width:" +
                        (loaded / total) * 100 +
                        "%;height:" +
                        getAudioPlayer()._currentPlayingRows[0].children[0]
                          .offsetHeight +
  ...
  input.style =
    "height:38px;font-size: medium;padding-left: 0.2em;    text-overflow: ellipsis;";
